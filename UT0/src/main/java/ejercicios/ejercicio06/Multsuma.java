...
public class Multsuma {
        // Sobrecarga de multsuma para tipos de datos double, numeros reales con gran precisión de muchos decimales luego de el entero.
    ...
    public static void main(String[] args) {
        // Llama a la versión double al ingresar números decimales, no enteros, en este caso, al ejecutar imprimirá 2.0.
